        ...
        <div class="panel panel-default">
          ...
          <div class="content-main">
              <article class="article">
                  ...
                  <div class="article-doc">${fn:replace(question.contents, replaceChar, "</br>")}</div>
                  <div class="article-util">
                      <ul class="article-util-list">
                          <li>
                              <a class="link-modify-article" href="/questions/updateFormQuestion?questionId=${question.questionId}">수정</a>
                          </li>
                          <li>
                              <form class="form-delete" action="/questions/deleteQuestion" method="POST">
                          ...
                          <c:forEach items="${question.answerList}" var="answer">
                              <article class="article" id="${answer.answerId}">
                                  ...
                                  <div class="article-doc comment-doc">
                                      ${fn:replace(answer.contents, replaceChar, "</br>")}
                                  </div>
                                  <div class="article-util">
                                      <ul class="article-util-list">
                                          <li>
